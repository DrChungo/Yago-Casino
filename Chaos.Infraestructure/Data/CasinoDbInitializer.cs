...
public static class CasinoDbInitializer
    {
        public static void Initialize(CasinoDBContext context)
        {
            ...
            //        {
            //            new() { Id = Guid.NewGuid(), Name = "Rex",      AnimalType = "DOG",   Health = 100, Rarity = true,  Age = 5,  Weight = 30m,   Height = 60m,  EstimatedValue = 1200m, IsAvailable = true, OwnerId = users[0].Id, AnimalValueConfigId = configs.First(c => c.AnimalType == "DOG").Id,   CreatedAt = now },
            //            new() { Id = Guid.NewGuid(), Name = "Whiskers", AnimalType = "CAT",   Health = 85,  Rarity = false, Age = 3,  Weight = 5m,    Height = 15m,  EstimatedValue = 300m,  IsAvailable = true, OwnerId = users[1].Id, AnimalValueConfigId = configs.First(c => c.AnimalType == "CAT").Id,   CreatedAt = now },
            //            new() { Id = Guid.NewGuid(), Name = "Thunder",  AnimalType = "CAT",   Health = 90,  Rarity = false, Age = 8,  Weight = 8m,    Height = 30m,  EstimatedValue = 8500m, IsAvailable = true, OwnerId = users[2].Id, AnimalValueConfigId = configs.First(c => c.AnimalType == "CAT").Id,   CreatedAt = now },
            //            new() { Id = Guid.NewGuid(), Name = "Bessie",   AnimalType = "COW",   Health = 75,  Rarity = false, Age = 10, Weight = 800m,  Height = 140m, EstimatedValue = 6000m, IsAvailable = true, OwnerId = users[3].Id, AnimalValueConfigId = configs.First(c => c.AnimalType == "COW").Id,   CreatedAt = now },
            //            new() { Id = Guid.NewGuid(), Name = "Fluffy",   AnimalType = "COW",   Health = 60,  Rarity = false, Age = 1,  Weight = 400m,  Height = 120m, EstimatedValue = 50m,   IsAvailable = true, OwnerId = users[4].Id, AnimalValueConfigId = configs.First(c => c.AnimalType == "COW").Id,   CreatedAt = now },
            //            new() { Id = Guid.NewGuid(), Name = "Jaws",     AnimalType = "SHARK", Health = 95,  Rarity = true,  Age = 6,  Weight = 500m,  Height = 200m, EstimatedValue = 6500m, IsAvailable = true, OwnerId = users[5].Id, AnimalValueConfigId = configs.First(c => c.AnimalType == "SHARK").Id, CreatedAt = now },
            //        };
            ...
            //        {
            //            new() { Id = Guid.NewGuid(), TransactionType = "Buy",          Amount = 1500m, TransactionDate = now.AddDays(-3).ToString(), UserId = users[0].Id, AnimalId = animals.First(a => a.Name == "Rex").Id      },
            //            new() { Id = Guid.NewGuid(), TransactionType = "SellToCasino", Amount = 9000m, TransactionDate = now.AddDays(-2).ToString(), UserId = users[2].Id, AnimalId = animals.First(a => a.Name == "Thunder").Id  },
            //            new() { Id = Guid.NewGuid(), TransactionType = "Buy",          Amount = 400m,  TransactionDate = now.AddDays(-1).ToString(), UserId = users[1].Id, AnimalId = animals.First(a => a.Name == "Whiskers").Id },
            //        });
            //                context.SaveChanges();
            //            }
        }
