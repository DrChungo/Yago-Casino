...
import imagenFondo from '../../assets/BiomasBG/casino_jungla.png';
import { chequearColisionRectangulos, limitesCielo, limite, obstaculos } from '../../AnimalMovement/JungleCollisions';
import JungleMusic from '../../assets/Audios/jungle_soundtrack.m4a';
...
export default function JunglePage() {
    ...
    useEffect(() => {
        const iniciarJuego = async () => {
            ...
            try {
                ...
                const JungleAnimals: AnimalData[] = arrayAnimales.map((ani: any) => {
                    ...
                    const esCielo = habitat === 'Jungle / Sky';
                    ...
                    a.habitat === 'Jungle' || a.habitat === 'Jungle / Sky'
                );

                estadoJuego.current.animales = JungleAnimals;
                setAnimalesRender(JungleAnimals);
                setCargando(false);
        ...
        function bucleDeJuego() {
            estadoJuego.current.animales.forEach(animal => {
                const limites = animal.habitat === 'Jungle / Sky' ? limitesCielo : limite;
    ...
    return (
        <div className="pagina-juego">
            ...
            <BackButton biome="Jungle" />
            <MusicButton
                playing={musicaSonando}
                onToggle={toggleMusica}
                biome="Jungle"
            />
            <BiomeSelector currentBiome="Jungle" />

            <audio ref={audioRef} src={JungleMusic} loop />
