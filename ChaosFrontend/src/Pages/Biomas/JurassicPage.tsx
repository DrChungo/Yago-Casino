...
import imagenFondo from '../../assets/BiomasBG/casino_jurasic.png';
import { chequearColisionRectangulos, limitesCielo, limite, obstaculos } from '../../AnimalMovement/JurassicCollisions';
import JurasicMusic from '../../assets/Audios/jurassic_soundtrack.m4a';
...
export default function JurassicPage() {
    ...
    useEffect(() => {
        const iniciarJuego = async () => {
            ...
            try {
                ...
                const JurassicAnimals: AnimalData[] = arrayAnimales.map((ani: any) => {
                    ...
                    const esCielo = habitat === 'Jurassic / Sky';
                    ...
                    a.habitat === 'Jurassic' || a.habitat === 'Jurassic / Sky'
                );

                estadoJuego.current.animales = JurassicAnimals;
                setAnimalesRender(JurassicAnimals);
                setCargando(false);
        ...
        function bucleDeJuego() {
            estadoJuego.current.animales.forEach(animal => {
                const limites = animal.habitat === 'Jurassic / Sky' ? limitesCielo : limite;
    ...
    return (
        <div className="pagina-juego">
            ...
            <BackButton biome="Jurassic" />
            <MusicButton
                playing={musicaSonando}
                onToggle={toggleMusica}
                biome="Jurassic"
            />
            <BiomeSelector currentBiome="Jurassic" />

            <audio ref={audioRef} src={JurasicMusic} loop />
