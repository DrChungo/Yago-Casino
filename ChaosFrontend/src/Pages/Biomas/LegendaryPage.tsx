...
import imagenFondo from '../../assets/BiomasBG/casino_legendary.png';
import { chequearColisionRectangulos, limitesCielo, limite, obstaculos } from '../../AnimalMovement/LegendaryCollisions';
import LegendaryMusic from '../../assets/Audios/legendary_soundtrack.m4a';
...
export default function LegendaryPage() {
    ...
    useEffect(() => {
        const iniciarJuego = async () => {
            ...
            try {
                ...
                const LegendaryAnimals: AnimalData[] = arrayAnimales.map((ani: any) => {
                    ...
                    const esCielo = habitat === 'Legend / Sky';
                    ...
                    a.habitat === 'Legend' || a.habitat === 'Legend / Sky'
                );

                estadoJuego.current.animales = LegendaryAnimals;
                setAnimalesRender(LegendaryAnimals);
                setCargando(false);
        ...
        function bucleDeJuego() {
            estadoJuego.current.animales.forEach(animal => {
                const limites = animal.habitat === 'Legend / Sky' ? limitesCielo : limite;
    ...
    return (
        <div className="pagina-juego">
            ...
            <BackButton biome="Legend" />
            <MusicButton
                playing={musicaSonando}
                onToggle={toggleMusica}
                biome="Legend"
            />
            <BiomeSelector currentBiome="Legend" />

            <audio ref={audioRef} src={LegendaryMusic} loop />
