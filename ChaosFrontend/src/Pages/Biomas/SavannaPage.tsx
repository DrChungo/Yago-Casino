...
import imagenFondo from '../../assets/BiomasBG/casino_savanna.png';
import { chequearColisionRectangulos, limitesCielo, limite, obstaculos } from '../../AnimalMovement/SavannaCollisions';
import SavannahMusic from '../../assets/Audios/savannah_soundtrack.m4a';
...
export default function SavannaPage() {
    ...
    useEffect(() => {
        const iniciarJuego = async () => {
            ...
            try {
                ...
                const SavannaAnimals: AnimalData[] = arrayAnimales.map((ani: any) => {
                    ...
                    const esCielo = habitat === 'Savanna / Sky';
                    ...
                    a.habitat === 'Savanna' || a.habitat === 'Savanna / Sky'
                );

                estadoJuego.current.animales = SavannaAnimals;
                setAnimalesRender(SavannaAnimals);
                setCargando(false);
        ...
        function bucleDeJuego() {
            estadoJuego.current.animales.forEach(animal => {
                const limites = animal.habitat === 'Savanna / Sky' ? limitesCielo : limite;
    ...
    return (
        <div className="pagina-juego">
            ...
            <BackButton biome="Savanna" />
            <MusicButton
                playing={musicaSonando}
                onToggle={toggleMusica}
                biome="Savanna"
            />
            <BiomeSelector currentBiome="Savanna" />

            <audio ref={audioRef} src={SavannahMusic} loop />
