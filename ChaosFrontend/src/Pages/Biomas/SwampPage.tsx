...
import imagenFondo from '../../assets/BiomasBG/casino_swamp.png';
import { chequearColisionRectangulos, limitesCielo, limite, obstaculos } from '../../AnimalMovement/SwampCollisions';
import SwampMusic from '../../assets/Audios/swamp_soundtrack.m4a';
    ...
    useEffect(() => {
        const iniciarJuego = async () => {
            ...
            try {
                ...
                const SwampAnimals: AnimalData[] = arrayAnimales.map((ani: any) => {
                    ...
                    const esCielo = habitat === 'Swamp / Sky';
                    ...
                    a.habitat === 'Swamp' || a.habitat === 'Swamp / Sky'
                );

                estadoJuego.current.animales = SwampAnimals;
                setAnimalesRender(SwampAnimals);
                setCargando(false);
        ...
        function bucleDeJuego() {
            estadoJuego.current.animales.forEach(animal => {
                const limites = animal.habitat === 'Swamp / Sky' ? limitesCielo : limite;
    ...
    return (
        <div className="pagina-juego">
            ...
            <MusicButton
                ...
                biome="Swamp"
            />
            <BiomeSelector currentBiome="Swamp" />

            <audio ref={audioRef} src={SwampMusic} loop />
